...
public class SystemMonitor {
    ...
    private static void print(){
        ...
        int finishTaskCount = testResult.getTaskCounter().get()==0?1:testResult.getTaskCounter().get();
        long avgTaskTime =  testResult.getActualTotalTime().get()/finishTaskCount;
        ...
        if(testResult.getTotalExecuteTime()/1000<1){
            ...
            currentTps = finishTaskCount*1000f/testResult.getTotalExecuteTime();
        }
        ...
        int actualSubmitTps = testResult.getSubmitTps();
        String subScript = "等待任务["+testResult.getTaskQueue().size()+"]当前提交tps["+actualSubmitTps+"]当前处理tps["+currentTpsStr+"]估算处理能力tps约["+mayTpsStr+"]";
